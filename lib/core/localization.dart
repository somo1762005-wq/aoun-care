class AppLocalization {
  static const Map<String, Map<String, String>> _localizedValues = {
    'ar': {
      ...
      'welcome_desc': 'ابدأ رحلة العناية الذكية بمتلقي الرعاية. تذكيرات، متابعة، وطمأنينة في مكان واحد🚀',
      'start_now': 'ابدأ الآن',
      ...
      'phone_number': 'رقم هاتف مقدم الرعاية (للطوارئ)',
      ...
      'role_caregiver': 'واجهة مقدم الرعاية',
      'role_elderly': 'واجهة متلقي الرعاية',
      
      // Care Recipient Interface
      'care_recipient_title': 'واجهة متلقي الرعاية',
      'father_dashboard': 'واجهة متلقي الرعاية',
      'time_to_take_medicine': 'حان وقت أخذ الدواء',
      ...
      'escalation_warning': 'تنبيه: سيتم إرسال إشعار لمقدم الرعاية في حال عدم التأكيد',
      'taken_success': 'تم تسجيل أخذ الجرعة بنجاح',
      
      // Caregiver Interface
      'caregiver_title': 'واجهة مقدم الرعاية',
      'son_title': 'واجهة مقدم الرعاية',
      ...
      // Tab 3: Live Map
      'live_tracking': 'التتبع المباشر لمتلقي الرعاية',
      'care_recipient_coordinates': 'إحداثيات الموقع الحالية لمتلقي الرعاية',
      ...
      'about_desc': 'تطبيق عوْن هو نظام ذكي لتتبع الأدوية والرعاية الصحية يربط بين متلقي الرعاية ومقدم الرعاية بشكل متزامن. يهدف التطبيق إلى الحفاظ على سلامة متلقي الرعاية من خلال التذكيرات التلقائية وتتبع المخزون ونظام التصعيد الذكي في حالات الطوارئ.',
      'language_settings': 'إعدادات اللغة',
      'share_app': 'شارك التطبيق',
      'share_text': 'أنصحك باستخدام تطبيق عوْن لرعاية وتتبع أدوية متلقي الرعاية بكل سهولة وطمأنينة.',
      'escalation_settings': 'إعدادات المهلة والتصعيد',
      'escalation_buffer_care_recipient': 'مهلة تأكيد متلقي الرعاية (بالدقائق)',
      'escalation_buffer_father': 'مهلة تأكيد متلقي الرعاية (بالدقائق)',
      'escalation_buffer_caregiver': 'مهلة تنبيه مقدم الرعاية قبل إرسال الرسالة النصية (بالدقائق)',
      'escalation_buffer_son': 'مهلة تنبيه مقدم الرعاية قبل إرسال الرسالة النصية (بالدقائق)',
      'logout': 'تسجيل الخروج',
      
      // Global
      'theme_mode': 'وضع المظهر',
      'language': 'اللغة',
      'sound_picker_title': 'نغمة التنبيه',
    },
    'en': {
      // Welcome Screen
      'welcome_title': 'Welcome to Aoun Care',
      'welcome_subtitle': 'With you in every moment of care',
      'welcome_desc': 'Begin the journey of smart care for the care recipient. Reminders, tracking, and peace of mind in one place🚀',
      'start_now': 'Start Now',
      ...
      'email': 'Email Address',
      'password': 'Password',
      'phone_number': 'Caregiver\'s Phone Number (Emergency)',
      ...
      'role_caregiver': 'Caregiver\'s Interface (Caregiver Mode)',
      'role_elderly': 'Care Recipient\'s Interface (Care Recipient Mode)',
      
      // Care Recipient Interface
      'care_recipient_title': 'Care Recipient\'s Dashboard',
      'father_dashboard': 'Care Recipient\'s Dashboard',
      ...
      // Caregiver Interface
      'caregiver_title': 'Caregiver\'s Dashboard',
      'son_title': 'Caregiver\'s Dashboard',
      ...
      // Tab 3: Live Map
      'live_tracking': 'Live Care Recipient Tracking',
      'care_recipient_coordinates': 'Care Recipient\'s Current Coordinates',
      ...
      'settings': 'Settings',
      'about_app': 'About App',
      'about_desc': 'Aoun Care is a smart medication tracking and health care synchronization system connecting the care recipient and the caregiver. It aims to keep care recipients safe via automated alerts, inventory tracking, and escalation policies.',
      'language_settings': 'Language Settings',
      'share_app': 'Share App',
      'share_text': 'I highly recommend using Aoun Care to track your care recipient\'s medication and care easily and with peace of mind.',
      'escalation_settings': 'Escalation & Safety Buffers',
      'escalation_buffer_care_recipient': 'Care Recipient Confirm Buffer (min)',
      'escalation_buffer_father': 'Care Recipient Confirm Buffer (min)',
      'escalation_buffer_caregiver': 'Caregiver Warning Buffer before SMS (min)',
      'escalation_buffer_son': 'Caregiver Warning Buffer before SMS (min)',
      'logout': 'Logout',
      
      // Global
      'theme_mode': 'Theme Mode',
      'language': 'Language',
      'sound_picker_title': 'Alarm Tone',
    }
  };
